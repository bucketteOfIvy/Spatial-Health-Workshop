...
We can start to introduce basemaps to explore more options for spatial visualization. Here, we'll use the Carto Voyager basemap, as found at [this useful preview website](https://leaflet-extras.github.io/leaflet-providers/preview). To keep things simple, we'll just visualize the borders using the `tm_borders` function.
