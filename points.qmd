...
```{r}
methadoneClinics <- read.csv("~/Documents/GitHub/Spatial-Health-Workshop/data/chicago_methadone_nogeometry.csv")
...
```{r}
Chi_Zipsf <- st_read("~/Documents/GitHub/Spatial-Health-Workshop/data/ChiZipMaster.geojson")
```
...
```{r, warning=FALSE}
AffHousing <- read.csv("~/Documents/GitHub/Spatial-Health-Workshop/data/Affordable_Rental_Housing_Developments.csv")
...
```{r eval=FALSE}
#st_write(methadoneSf, dsn = "~/Documents/GitHub/Spatial-Health-Workshop/data/methadoneMOUD.geojson")
```
