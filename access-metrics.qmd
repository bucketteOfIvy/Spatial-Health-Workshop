...
- Total number of Walkable MOUD Service Areas by zip code
...
points <- st_read("Data-2026/methadoneMOUD.geojson")
areas <- st_read("Data-2026/ChiZipMaster.geojson")
...
Next, count the number per area. The frequency should be logical according to the map you made earlier. Sometimes, I've found bugs where the numbers are multiplied by some factor; this can be checked by looking at dimension disparities, as noted above.
...
How could you improve on this step if you used `dplyr`?
...
Using your new spatial file, see if you can answer some of these questions using various queries:
...
Ready for the next step in calculating spatial access metrics and analyzing point patterns?
