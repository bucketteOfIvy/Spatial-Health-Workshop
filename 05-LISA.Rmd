...
```{r}
lisa.rook <- local_moran(w.rook, Chi_Zipsf.3435['Case.Rate...Cumulative'], permutations = 999)

lisa.queen2 <- local_moran(w.queen2, Chi_Zipsf.3435['Case.Rate...Cumulative'], permutations = 999)

lisa.queen2.449 <- local_moran(w.queen2, Chi_Zipsf.3435['Case.Rate...Cumulative'], permutations = 449)
