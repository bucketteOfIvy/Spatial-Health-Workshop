...
- Short link to this workbook: [go.illinois.edu/SpatialR-HealthyPlaces](https://go.illinois.edu/SpatialR-HealthyPlaces)
...
In addition to this workbook, you'll need a working instance of R and the data. You can also clone the [Github repository](https://github.com/healthyregions/r-spatial-healthy-places) that hosts this workbook to get direct access to all the working code, [data](https://github.com/healthyregions/r-spatial-healthy-places/blob/main/data), and additional items.
...
download_link(
  link = "https://github.com/healthyregions/r-spatial-healthy-places/blob/main/data/Data-2026.zip",
